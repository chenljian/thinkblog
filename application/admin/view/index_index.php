<div class="aright">
    <div class="aright_1">
        ...
        <blockquote style="padding: 10px;border-left: 5px solid #FF5722;" class="layui-elem-quote">系统信息：</blockquote>
        <table width="100%">
            <tr><td width="110px">原始代码</td><td><a href='http://tpt-content.tpt360.com' target="_blank" style='color: blue;'>tpt360后台 点击查看，请尊重源码提供者，本后端只是简单的博客文章管理</a></td></tr>
            <tr><td>感谢贡献者</td><td>Thinkphp及其原作者</td></tr>
            <tr><td>特别提醒</td><td>本程序均可免费下载使用，但严禁删除、隐藏或更改版权信息，且导致的一切损失由使用者自行承担。</td></tr>
            <tr><td>程序源代码</td><td><a href='http://tpt-content.tpt360.com' target="_blank" style='color: blue;'>github链接</a></td></tr>
        </table>
    </div>      
</div>